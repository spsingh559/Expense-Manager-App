  ...
  handleLogout=()=>{
    ...
    let retrievedUserDetails= JSON.parse(sessionStorage.getItem('userLoginDetails'));
		...
		return(
           ...
           <FlatButton backgroundColor={this.state.colorValNav1} style={style.labelStyle1} label="Home" onTouchTap={this.assesmentFormNavigation} />
           <FlatButton backgroundColor={this.state.colorValNav2} style={style.labelStyle} label="Add Expenses" onTouchTap={this.networkNavigation} />
           <FlatButton backgroundColor={this.state.colorValNav3} style={style.labelStyle} label="Previous Expenses" onTouchTap={this.networkTestingNavigation} />
...
<center>
        ...
        <Divider />
          ...
          <MenuItem onTouchTap={this.handleClose}>
          <Link to ="/history">Previous Expenses</Link>
          </MenuItem>
          <MenuItem onTouchTap={this.handleClose}>
